...
$base_url = 'https://test2.tuanori.me/'; // Thay url web bạn
...
class CMSNT
{
    ...
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'btshxuct_test2', 'btshxuct_test2', 'btshxuct_test2') or die ('Vui lòng kết nối đến DATABASE');
